# Process Definition Document (Synthetic Example)

**Project:** Business Account Opening – KYC Document Verification
**Client (fictional):** Meridian Bank, Business Banking Operations
**Document type:** PDD (Process Definition Document)
...
company's ownership structure before the account can be activated. This PDD
covers the **document verification** sub-process only (not the full onboarding
journey).
...
**Out of scope:** Account activation itself, credit checks, ongoing periodic
KYC refresh (covered under a separate process).

## 6. Stakeholders
- Business Banking Operations (process owner)
- MLRO team (escalation recipient)
- IT/Automation team (this project)

---
*Note: sections deliberately mirror a typical PDD structure but are trimmed
for the purposes of this exercise — a real PDD would be considerably longer.*
